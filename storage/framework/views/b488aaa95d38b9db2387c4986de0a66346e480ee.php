...
} elseif ($_instance->childHasBeenRendered('gXn72Xu')) {
    $componentId = $_instance->getRenderedChildComponentId('gXn72Xu');
    $componentTag = $_instance->getRenderedChildComponentTagName('gXn72Xu');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('gXn72Xu');
} else {
    $response = \Livewire\Livewire::mount('products');
    $html = $response->html();
    $_instance->logRenderedChild('gXn72Xu', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
